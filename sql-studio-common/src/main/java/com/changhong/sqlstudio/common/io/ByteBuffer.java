...
public abstract class ByteBuffer
{
         ...
         * 以及稳定性
         *
         * @param b   读取 {@link ByteBuffer} 中数据到 {@code b} 这个字节数组中
         * @param off 字节数组起始索引，从 {@code b[off]} 开始写入第一个字节
         * @param len 读取的总长度，字节数组结束索引为 {@code b[off + len]}
         */
         ...
         *
         * @param b   写入的数据内容字节数组
         * @param off 从参数 {@code b[off]} 位置开始读取数据写入到 {@link ByteBuffer}
         * @param len 字节数组的结束位置，读取的内容从 {@code b[off]} 到 {@code b[len]}
         */
