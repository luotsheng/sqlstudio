package com.changhong.sqlstudio.common.time;
...
import com.changhong.sqlstudio.common.exception.ValidationException;
import com.changhong.sqlstudio.common.utils.Captor;

import java.text.SimpleDateFormat;
import java.util.Date;

import static com.changhong.sqlstudio.common.string.StringUtils.strcheckin;
import static com.changhong.sqlstudio.common.string.StringUtils.strlen;
...
public class DateFormatter
{
         ...
         * 足线程安全要求。
         *
         * @param date    格式化日期对象，如：“DateFormatter.now()”
         * @param pattern 格式化规则，如：“yyyy-MM-dd”
         * @return 格式化后的字符串
         */
         ...
         * 足线程安全要求。
         *
         * @param text    解析日期对象，如：“2018-12-18”
         * @param pattern 格式化规则，如：“yyyy-MM-dd”
         * @return 解析后的字符串
         */
