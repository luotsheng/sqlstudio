package com.changhong.sqlstudio.common.utils;
...
import com.changhong.sqlstudio.common.iface.TypeMapper;
import com.changhong.sqlstudio.common.io.ByteBuffer;
import com.changhong.sqlstudio.common.reflect.UClass;
import com.changhong.sqlstudio.common.string.StringInterface;
import com.changhong.sqlstudio.common.string.StringUtils;
...
public class TypeCvt
{
        ...
        public static byte[] atob(Object obj)
        {
                ...
                throw new UnsupportedOperationException("atob：暂不支持当前类型转字节数组");
        }
         ...
         *
         * @param b   字节数组，数组长度最低不能小于 4 个字节
         * @param off 偏移量，从 {@code b[off]} 往后取 4 个字节。
         * @return 转换后的 int 类型数据。
         */
         ...
         *
         * @param b   字节数组，数组长度最低不能小于 8 个字节
         * @param off 偏移量，从 {@code b[off]} 往后取 8 个字节。
         * @return 转换后的 long 类型数据。
         */
         ...
         * @param len 新的字符串长度，该长度不能超过 {@code sub} 被截取的子字符串长度
         * @return 根据 {@code off} 和 {@code len} 分配出来的新字符串
         * @throws NullPointerException           {@code sub} 子字符串参数不能为空
         * @throws ArrayIndexOutOfBoundsException 如果参数 {@code len} 超出整个子字符串的大小后会抛出数组越界异常。
         */
         ...
         * @param sub 子字符串对象实例
         * @param off 子字符串中第一个字符开始的索引位置
         * @param len 新的字符串长度，该长度不能超过 {@code sub} 被截取的子字符串长度。如果长度
         ...
         * @return 根据 {@code off} 和 {@code len} 分配出来的新字符串
         * @throws ArrayIndexOutOfBoundsException 如果参数 {@code len} 超出整个字符数组的大小后会抛出数组越界异常。
         ...
         *
         * @param a   被截取的字符数组
         * @param off 字符数组中第一个字符开始的索引位置
         * @param len 新的字符串长度，该长度不能超过 {@code a} 被截取的字符数组长度
         * @return 根据 {@code off} 和 {@code len} 分配出来的新字符串
         * @throws ArrayIndexOutOfBoundsException 如果参数 {@code len} 超出整个字符数组的大小后会抛出数组越界异常。
