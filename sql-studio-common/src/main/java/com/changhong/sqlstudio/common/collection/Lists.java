package com.changhong.sqlstudio.common.collection;
...
import com.changhong.sqlstudio.common.utils.ArrayUtils;
...
public class Lists
{
         ...
         * 接口的子接口。
         *
         * @param a 一个 {@link Collection} 接口对象实例
         ...
         *
         * @param collection 实现了 {@link Collection} 接口的对象实例，如 {@link ArrayList}、{@link LinkedList} 等
         ...
         *
         * @param a 实现了 {@link Collection} 接口的对象实例，如 {@link ArrayList}、{@link LinkedList} 等
         *          对象实例皆实现了 {@link Collection} 接口。
         ...
         *
         * @param builder Lambda 函数实现接口，或者也可以通过实现 {@link TypeMapper} 接口的方式
         *                完成这个参数。
         * @param a       输入数组
         ...
         * @param builder    Lambda 函数实现接口，或者也可以通过实现 {@link TypeMapper} 接口的方式
         *                   完成这个参数。
         * @param collection 实现了 {@link Collection} 接口的对象实例
         * @return 返回通过 {@link TypeMapper} 转换后的集合实例。
         */
