package com.changhong.sqlstudio.common.system;
...
import com.changhong.sqlstudio.common.time.Chrono;

import java.util.Map;

import static com.changhong.sqlstudio.common.string.StringUtils.stricheckin;
import static com.changhong.sqlstudio.common.string.StringUtils.strrexp;
...
public class SystemUtils
{
         ...
         *
         * @param sub 要附加在用户主目录路径后的子路径，如果为 {@code null}，则不附加任何内容
